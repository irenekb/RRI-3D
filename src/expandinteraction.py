...
'''
Example
python3 expandinteraction.py  -b 2 -n expample.seq -x expample.bp -o expample_01.ss
python3 expandinteraction.py  -b 2 -n expample.seq -d expample.ss -o expample_02.ss
'''
